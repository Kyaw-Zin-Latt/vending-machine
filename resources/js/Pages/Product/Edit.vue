                ...
                <div class="bg-white px-2 overflow-hidden shadow-xl sm:rounded-lg">
                    ...
                    <div class="max-w-sm my-3">
                        ...
                        <div class="flex">
                            ...
                            <button @click="handleSubmit(product.id)" type="button" class="text-white w-1/2 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Submit</button>
                        </div>
                    </div>
...
export default defineComponent({
    ...
    props:['status', 'errors', 'currencies', 'product'],
    setup(props) {
        ...
        function handleSubmit(id) {
            this.$inertia.post(route('admin.products.update', id), form)
        }
